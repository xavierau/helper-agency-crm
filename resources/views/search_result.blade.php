                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="white_box">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="title-page">
                                                <p>{{__("Applicant Search")}} - {{__("Total")}}
                                                    : {{$paginator->total()}}</p>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-xs-12">
                                            <div class="title-page text-right">
                                                <p>{{__("Page")}} {{$paginator->currentPage()}}
                                                    / {{$paginator->lastPage()}}</p> </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <a href="{{'applicants_enquiry'}}"
                                       class="btn btn-success">{{__("Send Enquiry")}}</a>
