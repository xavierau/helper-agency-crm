<template>
    <div>
        ...
        <CRow>
            <CCol sm="6" lg="3">
                <WaitingForApproveApplicant/>
            </CCol>
            <CCol sm="6" lg="3">
                <CurrentMonthTotalPayment/>
            </CCol>
            <CCol sm="6" lg="3">
                <CurrentMonthNewContract/>
            </CCol>
        </CRow>

        <CRow>
            <CCol md="6">
                <PendingContractWidget style="height: 500px; overflow:scroll"/>
            </CCol>
            <CCol md="6">
                <ExpiringContractsWidget style="height: 500px; overflow:scroll"/>
            </CCol>
        </CRow>
        <!--        <CCard>-->
        <!--            <CCardBody>-->
...
import WaitingForApproveApplicant from "@/widgets/WaitingForApproveApplicant";
import CurrentMonthTotalPayment from "@/widgets/CurrentMonthTotalPayment";
import CurrentMonthNewContract from "@/widgets/CurrentMonthNewContract";
import PendingContractWidget from "@/modules/Contract/widgets/PendingContractWidget";
import ExpiringContractsWidget from "@/modules/Contract/widgets/ExpiringContracts";
