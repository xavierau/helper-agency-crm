    ...
    <div class="WorkflowIndex">
        <CCard>
            <CCardHeader class="d-flex justify-content-between align-content-center">
                <h5 class="m-0">Contract Documents</h5>
        ...
        <CModal :show.sync="showCreateModal"
                ...
                static
                size="xl">
            <contract-doc-form :form-data.sync="formData"/>
            <template #footer>
        ...
        <CModal :show.sync="showEditModal"
                ...
                static
                size="xl">
            <contract-doc-form v-if="selectedContractDate" :form-data.sync="selectedContractDate"/>
            <template #footer>
...
import ContractDocForm from "../views/partials/ContractDocForm"
