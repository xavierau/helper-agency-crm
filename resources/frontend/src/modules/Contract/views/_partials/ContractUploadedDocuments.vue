...
export default {
    name: "ContractUploadedDocuments",
    props: {
        contractId: {
            type: Number,
            required: true
    ...
    methods: {
        fetchUploadedDocuments() {
            client.get(endpoints.uploaded_documents(this.contractId))
        ...
        submit(e) {
            ...
            client.post(endpoints.store_uploaded_documents(this.contractId), data)
